<?php
//Shortcode : For Display Supplier Directory section at Home Page 
$args = array(
	'post_type' => 'Supplier',
	'post_status'  =>  'publish',
	'order'       => 'DESC',
...
<script type="text/javascript">
    ...
    jQuery(".cstm_supplier_post").slice(0,8).show();
      
	jQuery("#loadMoreSupplier").click(function(e){
        e.preventDefault();
        jQuery(".cstm_supplier_post:hidden").slice(0,8).fadeIn("slow");
